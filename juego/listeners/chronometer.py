...
class Cronos:
    ...
    def draw(self, win, ini, outline=None, modo=None, n=None):
        ...
        if modo == 1:
            self.seconds = int(pygame.time.get_ticks() / 1000)-ini
            ...
            if n == 3:
                ...
                self.seconds = int((tempo - pygame.time.get_ticks()) / 1000)+ini
                self.minutes = int(self.seconds / 60)
                self.seconds = self.seconds % 60
            elif n == 4:
